...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const handleMove = (e) => {
      ...
      const orbs = hero.querySelectorAll(".home__orb");
      orbs.forEach((orb, i) => {
  ...
  const features = [
    {
      ...
      desc: "Zero-latency communication powered by WebSocket. Every message arrives instantly.",
    },
    {
      icon: "🔒",
      title: "End-to-End Secure",
      desc: "JWT authentication with refresh tokens. Your conversations stay private, always.",
    },
    {
      icon: "🚪",
      title: "Private Rooms",
      desc: "Create or join rooms with a unique ID. Full control over who joins your space.",
    },
    {
      icon: "🌐",
      title: "OAuth Login",
      desc: "Sign in with Google in one click. No extra passwords to remember.",
    },
    {
      icon: "📧",
      title: "Smart Notifications",
      desc: "Email alerts for logins, resets, and new messages — keeping you always in the loop.",
    },
    {
      icon: "🎨",
      title: "Sleek Interface",
      desc: "A minimal, distraction-free UI built for focus. Looks great on any device.",
    },
  ];
    ...
    <div className="home">
      ...
      <section className="home__banner">
        ...
        <div className="home__banner-inner">
          ...
          <button
            className="home__cta home__cta--white"
            onClick={() => navigate("/register")}
          >
            Create free account
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
